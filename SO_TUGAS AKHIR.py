...
class PrioritySchedullingNonPreemptive:
    def processData(self, nomer_process):
        ...
        for i in range (nomer_process):
            ...
            arrival_time = int(input(f"Masukkan Arrival Time untuk Process {process_id}: "))
            ...
            temp.extend([process_id, 0 ,arrival_time, waktu_burst, waktu_prioritas])
    ...
    def findavgTime(self, process_queue):
        ...
        print("Process ID\tArrival Time\tWaiting Time\tTurnaround Time")
